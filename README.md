...
| 1.3.3   | <ul><li>**Update:** Authored by [@marzepani](https://github.com/marzepani) and [@uberboom](https://github.com/uberboom). Added support for image captions, overlay is closed on scroll events.</li></ul> |
